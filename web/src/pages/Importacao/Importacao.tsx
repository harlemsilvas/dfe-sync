    ...
    <>
      <div className="content-header">
        ...
        <p className="page-subtitle">
          Importe e processe documentos fiscais automaticamente
        </p>
      </div>
          ...
          <div className="card-body">
            ...
            <div className="alert alert-info" style={{ marginTop: "20px" }}>
              ...
              <ul style={{ marginTop: "8px", marginBottom: "0" }}>
                <li>
                  <code>/mnt/c/Users/usuario/Desktop/contabilidade/xml</code>
                </li>
                <li>
                  <code>/home/usuario/documentos/nfe</code>
                </li>
                <li>
                  <code>/var/data/fiscal/importacao</code>
                </li>
              </ul>
            </div>
          </div>
              ...
              {results.uploads ? (
                ...
                <div>
                  <div className="alert alert-success">
                    <strong>Upload concluído!</strong> {results.uploads.length}{" "}
                      ...
                      <tbody>
                        {results.uploads.map((upload: any, index: number) => (
                          <tr key={index}>
                            ...
                            <td>
                              <span
                                className={`badge ${upload.success ? "badge-success" : "badge-danger"}`}
                              >
                  ...
                  {results.detalhes && results.detalhes.length > 0 && (
                    ...
                    >
                      <table className="table">
                        ...
                        <tbody>
                          {results.detalhes.map(
                            (detalhe: any, index: number) => (
                              <tr key={index}>
                                <td>{detalhe.arquivo}</td>
                                <td>
                                  <span
                                    className={`badge ${detalhe.success ? "badge-success" : "badge-warning"}`}
                                  >
                                    {detalhe.status}
                                  </span>
                                </td>
          ...
          <div className="card-body">
            <div className="alert alert-info">
              ...
              <ol style={{ marginTop: "10px", marginBottom: "0" }}>
                <li>
                  <strong>Extração:</strong> Arquivos compactados são extraídos
                  automaticamente
                </li>
                <li>
                  <strong>Validação:</strong> XMLs são validados quanto à
                  estrutura e conteúdo
                </li>
                <li>
                  <strong>Classificação:</strong> Documentos são classificados
                  conforme regras configuradas
                </li>
                <li>
                  <strong>Organização:</strong> Arquivos são organizados na
                  estrutura de pastas
                </li>
                <li>
                  <strong>Indexação:</strong> Metadados são armazenados no banco
                  de dados
                </li>
              </ol>
            </div>
            ...
            <div className="alert alert-warning">
              ...
              <ul style={{ marginTop: "8px", marginBottom: "0" }}>
                <li>
                  <strong>XML:</strong> Arquivos individuais de NF-e, CT-e,
                  NFS-e
                </li>
                <li>
                  <strong>ZIP:</strong> Arquivos compactados ZIP
                </li>
                <li>
                  <strong>RAR:</strong> Arquivos compactados RAR
                </li>
                <li>
                  <strong>7Z:</strong> Arquivos compactados 7-Zip
                </li>
              </ul>
            </div>
          </div>
